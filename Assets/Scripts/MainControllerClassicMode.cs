...
public class MainControllerClassicMode : MonoBehaviour {
    ...
    private void Dead()
    {
        ...
        PlayerPrefs.SetString(GlobalStrings.CURRENT_MODE, GlobalStrings.CLASSIC_MODE);
    ...
    {
        if(PlayerPrefs.HasKey(GlobalStrings.HIGH_SCORE_CLASSIC_STRING))
        {
            int currentHighScore = PlayerPrefs.GetInt(GlobalStrings.HIGH_SCORE_CLASSIC_STRING);
            if(Score > currentHighScore)
            {
                PlayerPrefs.SetInt(GlobalStrings.HIGH_SCORE_CLASSIC_STRING, Score);
            }
        }
        else
        {
